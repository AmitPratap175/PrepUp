...
from .tools.erroranalysis import erroranalysis_tool

class ErrorAnalysisAgentState(TypedDict):
    messages: Annotated[Sequence[BaseMessage], operator.add]

tools = [erroranalysis_tool]
...
def agent_node(state: ErrorAnalysisAgentState):
...
workflow = StateGraph(ErrorAnalysisAgentState)
