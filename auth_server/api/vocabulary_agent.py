...
from .tools.vocabulary import vocabulary_tool

class VocabularyAgentState(TypedDict):
    messages: Annotated[Sequence[BaseMessage], operator.add]

tools = [vocabulary_tool]
...
def agent_node(state: VocabularyAgentState):
...
workflow = StateGraph(VocabularyAgentState)
