...
from .tools.goal_setting import create_study_plan

class GoalSettingAgentState(TypedDict):
...
prompt_template = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            "You are a helpful assistant who helps users set and manage their study goals.",
        ),
        MessagesPlaceholder(variable_name="messages"),
    ]
)

def agent_node(state: GoalSettingAgentState):
...
workflow = StateGraph(GoalSettingAgentState)
