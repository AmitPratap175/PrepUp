...
from .tools.gamification import gamification_tool

class GamificationAgentState(TypedDict):
...
def agent_node(state: GamificationAgentState):
...
workflow = StateGraph(GamificationAgentState)
