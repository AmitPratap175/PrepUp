...
from .tools.motivation import motivation_tool

class MotivationAgentState(TypedDict):
...
def agent_node(state: MotivationAgentState):
...
workflow = StateGraph(MotivationAgentState)
