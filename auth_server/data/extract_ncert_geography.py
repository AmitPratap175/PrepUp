...
Usage:
    python extract_ncert_geography.py \
        --input "NCERT_MCQs_Geography.pdf" \
        --output ncert_geography.json
...
PAGE_START = 7    # inclusive, 0-indexed
...
PAGE_HDR_RE = re.compile(
    ...
    r'|\d{2}\s*\nof\s+[A-Za-z ]+(?:History|Geography)'  # "03\nof Ancient History"
...
CHAPTER_MAP = {
    7: ('01', 'Geography as a Discipline'),
    9: ('02', 'The Universe'),
    14: ('03', 'The Earth'),
    26: ('04', 'Geomorphology'),
    48: ('05', 'Climatology'),
    ...
    82: ('07', 'Biogeography'),
    94: ('08', 'Agriculture'),
    106: ('09', 'Mineral and Energy Resources'),
    113: ('10', 'Industries'),
    121: ('11', 'Transport and Communication'),
    128: ('12', 'World Population and Human Development'),
    135: ('13', 'Human Settlements and Tribes'),
    140: ('14', 'Continents'),
    167: ('16', 'Location and Structure of India'),
    171: ('17', 'Physiographic Divisions of India'),
    184: ('18', 'Drainage of India'),
    194: ('19', 'Climate of India'),
    202: ('20', 'Soils and Natural Vegetation'),
    210: ('21', 'Natural Resources of India'),
    216: ('22', 'Agriculture'),
    225: ('23', 'Mineral and Energy Resources in India'),
    234: ('24', 'Industries'),
    243: ('25', 'Transport and Communication'),
    250: ('26', 'Human Settlements'),
    252: ('27', 'Environment'),
    254: ('28', 'Ecology and Ecosystem'),
    261: ('29', 'Biodiversity'),
    274: ('32', 'Environmental Issues'),
    281: ('33', 'Sustainable Development'),
    283: ('34', 'Disaster Management'),
...
def build_entry(parsed: dict, chapter_num: str, chapter_name: str, global_idx: int) -> dict:
    ...
    qid = f"ncert-geo-ch{chapter_num}-q{parsed['q_num']}"
...
def main():
    parser = argparse.ArgumentParser(
        description="Extract NCERT Geography MCQs"
    )
    parser.add_argument('--input',  default="/media/dspratap/Maxtor/UPSC/Books/NCERT MCQs India & World Geography Class 6-12 (Old + New) -- Vivek Sharma, Rajpriya -- 2022 -- Arihant Publications India limited -- isbn13 9789326191098 -- 094ff85ebad530d3f0aa9f035a7cfeb3 -- Anna’s Archive.pdf", help='PDF path')
    parser.add_argument('--output', default='ncert_geography_mcqs.json')
