...
function SectionalTestInterfaceContent({ testId }: SectionalTestInterfaceProps) {
...
export default function SectionalTestInterface(props: SectionalTestInterfaceProps) {
    return (
        <SidebarProvider>
            <SectionalTestInterfaceContent {...props} />
        </SidebarProvider>
    )
}
