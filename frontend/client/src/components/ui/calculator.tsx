    ...
    <motion.div ref={ref} drag whileDrag={{ scale: 1.02 }} dragMomentum={false} className="fixed bottom-24 right-5 z-50">
      ...
      >
        ...
        <div className="grid grid-cols-5 gap-1 p-2 bg-muted/20">
          ...
          <Button onClick={() => setDisplay(display.slice(0, -1) || '0')} variant="secondary">
            &larr;
          </Button>
          ...
          <Button onClick={() => handleOperatorClick('-')} variant="secondary">-</Button>
          <Button onClick={handleEqualsClick} className="row-span-2 bg-primary text-primary-foreground hover:bg-primary/90">
            =
          </Button>
